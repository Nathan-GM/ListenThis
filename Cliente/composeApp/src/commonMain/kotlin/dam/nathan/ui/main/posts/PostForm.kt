...
@Composable
fun PostForm(user: UserwithToken, volver: () -> Unit) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Nuevo post de ${user.user!!.username}") },
        ...
        Column(
            ...
            if (waiting) {
                ...
                if (error) {
                    Text(
                        text = "Ha ocurrido un problema al tratar de crear el post. \n Intentalo de nuevo más tarde",
                        color = MaterialTheme.colorScheme.error
                    )
                }
    ...
    Box(
        ...
        ExposedDropdownMenuBox(
            ...
            TextField(
                ...
                trailingIcon = {
                    Icon(
                        imageVector = if(expanded) Icons.Filled.ArrowCircleUp else Icons.Filled.ArrowCircleDown,
